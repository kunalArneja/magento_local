...
use Narvar\Connect\Helper\Config\Labels as LabelsHelper;
...
use Narvar\Connect\Helper\Config\Brand;
use Narvar\Connect\Helper\Config\Locale;
use Narvar\Connect\Helper\Cron\Log as LogHelper;
...
class Activator
{
     ...
     * @return mixed
     */
    public function getConfigValue($path, $scopeId = null, $scopeType = ScopeInterface::SCOPE_STORE)
    {
