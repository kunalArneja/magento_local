...
use Narvar\Connect\Helper\CurlFileUploaderFactory;
...
class Uploader extends \Magento\Framework\DataObject
{
    ...
    /**
     *
     * @var \Narvar\Connect\Helper\CurlFileUploader
     */
    ...
    {
        /**
         * @var \Narvar\Connect\Model\ResourceModel\Audit\Log\Collection $logs
         */
    ...
    public function getLogsByPage($storeId, $page){
        ...
        /**
         * @var \Narvar\Connect\Model\ResourceModel\Audit\Log\Collection $collection
         */
