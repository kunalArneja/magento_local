...
use Narvar\Connect\Helper\Config\Attribute as ConfigAttribute;
...
class Formatter extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     *
     * @var \Narvar\Connect\Helper\Config\Attribute
     */
    ...
    {
        $xmlPath = $this->moduleDirReader->getModuleDir(ModuleDir::MODULE_ETC_DIR, 'Narvar_Connect') .
        "/field_mapper.xml";
