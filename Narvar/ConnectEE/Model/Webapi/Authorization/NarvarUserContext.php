 ...
 */
namespace Narvar\ConnectEE\Model\Webapi\Authorization;

use Magento\Authorization\Model\UserContextInterface;
use Magento\Framework\Webapi\Request;
use Magento\Framework\Webapi\Exception as WebApiException;
use Narvar\ConnectEE\Helper\Config\Returns as ReturnHelper;
use Narvar\ConnectEE\Helper\Handshake;
use Narvar\ConnectEE\Helper\Config\Account as AccountConfigHelper;
...
class NarvarUserContext implements UserContextInterface
{
     ...
     * @param AccountConfigHelper $accountConfigHelper
     */
    ...
    private function isValidUser()
    {
        if ($this->request->getPathInfo() === Handshake::RETURN_SLUG) {
            if ($this->request->getHeader('AUTHORIZATION') && $this->getBasicAuth() === $this->request->getHeader('AUTHORIZATION')) {
                return true;
            }
