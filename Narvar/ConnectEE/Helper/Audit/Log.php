...
class Log extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     *
     * @var \Narvar\ConnectEE\Model\Audit\LogFactory
     */
     ...
     *
     * @param array $logData
     * @return \Narvar\ConnectEE\Model\Audit\LogFactory
     */
    ...
    public function __call($method, $args)
    {
        if (substr($method, 0, 6) == 'update') {
            $statusClass = new \ReflectionClass('Narvar\ConnectEE\Helper\Audit\Status');
    ...
    {
        if ($entityType != Type::ENT_TYPE_ORDER && $entityType != Type::ENT_TYPE_RMA) {
            $entityType = Type::ENT_TYPE_ORDER;
        }
